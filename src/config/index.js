...
export const options = [
  {
    image: "assets/options/1.jpg",
    fr: {
      name: "ANIMATION COCKTAIL",
      description:
  ...
  {
    image: "assets/options/2.jpg",
    fr: {
      name: "CARICATURISTE",
      description:
        "Si vous souhaitez mettre une touche d’humour à votre évènement , et par la même occasion laisser un souvenir à chacun de vos invités , permettez leur de se prêter au jeu de la caricature dans la joie et la…",
    },
    en: {
      name: "CARTOONIST",
      description:
  ...
  },
  {
    ...
    fr: {
      name: "VIOLON",
      description:
        "Rien n est plus magique ni harmonieux que de mettre de la symphonie dans des musiques revisitées par le talent de nos artistes-violonistes.",
    },
    en: {
      name: "VIOLIN",
      description:
  ...
  {
    image: "assets/options/4.jpg",
    fr: {
      name: "DEUX DANSEUSES",
      description:
        "Les danseuses sauront vous ravir et créer une ambiance dynamique tout au long de votre soirée . Elles se changeront quatre fois en fonction des thèmes musicaux abordés et arboreront des tenues au style aussi différent qu’original Nous vous proposons…",
    },
    en: {
      name: "TWO DANCERS",
      description:
  ...
  },
  {
    ...
    fr: {
      name: "RIDEAU SURPRISE",
      description: "Et bien c’est une surprise …",
    },
    en: {
  ...
  {
    image: "assets/options/6.jpg",
    fr: {
      name: "ROBOT LED",
      description:
        "Pour une entrée en salle exceptionnelle des mariés ou du Bar-mitsva ou au milieu de votre soirée , cette attraction époustouflante et futuriste enflammera comme il se doit votre piste de danse",
    },
    en: {
      name: "LED ROBOT",
      description:
  ...
  {
    image: "assets/options/7.jpg",
    fr: {
      name: "PISTOLET CO2",
      description:
        "Après avoir enflammé votre dance floor , vos invités seront ravis de recevoir une bouffée d’oxygène rafraîchissante.",
    },
    en: {
      name: "CO2 GUN",
      description:
  ...
  },
  {
    ...
    fr: {
      name: "PISTE DE DANSE ",
      description:
        "Vous êtes friands de techno , cette piste de danse illuminera votre dance floor de manière spectaculaire.",
    },
    en: {
      name: "DANCEFLOOR",
      description:
  ...
  {
    image: "assets/options/9.jpg",
    fr: {
      name: "PIANO A QUEUE",
      description:
        "Placé au milieu de votre piste de danse , ce piano créera une ambiance chaleureuse et vos invités pourront , s’ils le souhaitent , pendant le repas , se joindre à nos artistes pour interpréter des standards connus .",
    },
    en: {
      name: "GRAND PIANO",
      description:
  ...
  },
  {
    ...
    fr: {
      name: "PHOTO CABINE",
      description:
        "The Voices présente cette nouvelle animation . Elle permettra à vos invités d’immortaliser d moments uniques et de vivre de grandes rigolades.",
    },
    en: {
      name: "PHOTO BOOTH",
      description:
  ...
  {
    image: "assets/options/11.jpg",
    fr: {
      name: "MUR VIDEO",
      description:
        "Notre mur d’images séduira les amateurs de technologie tout en créant un effet lumineux ultramoderne . UN VIDEO-JOCKEY LE FERA FONCTIONNER . Aux commandes , son rôle sera de créer une véritable interactivité avec vos invités en diffusant les clips…",
    },
    en: {
      name: "VIDEO WALL",
      description:
  ...
  },
  {
    ...
    fr: {
      name: "MISE EN LUMIERE DE LA SALLE",
      description:
        "Rendez la salle encore plus belle, pour une ambiance sur mesure.",
    },
    en: {
      name: "LIGHTING",
      description:
  ...
  {
    image: "assets/options/13.jpg",
    fr: {
      name: "MAGICIEN",
      description:
        "Si vous appréciez les effets magiques et mystérieux, un illusionniste fera son entrée dans votre soirée.",
    },
    en: {
      name: "MAGICIAN",
      description:
  ...
  },
  {
    ...
    fr: {
      name: "KIT DE LA FETE",
      description:
        "Laissez les cotillons les serpentins et chapeaux pointus mettre de la couleur et de la folie au milieu de vos invités.",
    },
    en: {
      name: "GOODIES",
      description:
  ...
  {
    image: "assets/options/15.jpg",
    fr: {
      name: "GOSPEL",
      description:
        "Les chants de Gospel ajouteront un charme solennel à votre événement tout en dynamisant l’atmosphère.",
    },
    en: {
      name: "GOSPEL",
      description:
  ...
  },
  {
    ...
    fr: {
      ...
      description:
        "Pour une entrée à couper le souffle , deux feux d’artifices seront déployés de part et d’autre de la piste . Effet éclatant garanti !!! ( sachez que cette animation ne peut pas être réalisée dans toutes les salles )",
    },
    en: {
      name: "FIREWORKS",
      description:
  ...
  {
    image: "assets/options/17.jpg",
    fr: {
      name: "FACE PAINTING",
      description:
        "Le talent de cet artiste ne manquera pas d’éblouir vos invités et de leur laisser un souvenir qu’ils garderont en mémoire très longtemps",
    },
    en: {
      name: "FACE PAINTING",
      description:
  ...
  },
  {
    ...
    fr: {
      name: "DRIBBLEUR",
      description:
        "Passionné de ballon rond ou non , impressionnez toute votre assistance avec cette extraordinaire démonstration d’ agilité et d’adresse qu’il effectuera sous vos yeux pour le plaisir de tous.",
    },
    en: {
      name: "DRIBBLER",
      description:
  ...
  {
    image: "assets/options/19.jpg",
    fr: {
      name: "DANSEUSE ORIENTALE",
      description:
        "D’abord en solo dans une chorégraphie embrasante , elle captivera chacun de vos invités pour ensuite les attirer dans des mouvements et des ondulations dont elle seule a le secret .",
    },
    en: {
      name: "BELLY DANCER",
      description:
  ...
  },
  {
    ...
    fr: {
      name: "DANSEUSES BRESILIENNES",
      description:
        "Ne résistez plus aux rythmes enflammés de la samba brésilienne grâce à nos sublimes artistes qui entraîneront vos invités dans une ambiance festive et chaleureuse.",
    },
    en: {
      name: "BRAZILIAN DANCERS ",
      description:
  ...
  {
    image: "assets/options/22.jpg",
    fr: {
      name: "BREAK DANSEURS",
      description:
        "Les breaks danseurs mettront une ambiance moderne et endiablée . Ils présenteront un show de 20 minutes à couper le souffle . Votre enfant sera mis à l’honneur en participant à leur extraordinaire chorégraphie .",
    },
    en: {
      name: "BREAKDANCE",
      description:
  ...
  },
  {
    ...
    fr: {
      name: "BAR ACTIF",
      description:
        "Cette animation est proposée sous trois formules. Formule 1 : – 2 activeuses préparent des cocktail alcoolisés ou pas et ensuite viennent servir vos invités sur la piste de danse. Formule 2 : – 1 bar à proximité de la…",
    },
    en: {
      name: "ACTIVE BAR",
      description:
  ...
  {
    image: "assets/options/24.jpg",
    fr: {
      name: "BAR A BONBONS",
      description:
        "Réservez un espace gourmand et décoratif à votre évènement en créant un buffet de bonbons ludique et raffiné garni de sucreries.",
    },
    en: {
      name: "CANDY BAR",
      description:
